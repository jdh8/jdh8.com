...
**This repo:** Chinese site (梅花雀莊, jdh8.com). Content lives in `_posts`, `_data`, `assets`, `tools`. Adds CJK font stacks and quote marks in `_sass/typography.scss`, plus `jekyll-redirect-from` for legacy URLs.
